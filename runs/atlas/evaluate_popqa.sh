...
#SBATCH --job-name=evaluate-popqa
#SBATCH --error=./logs/evaluate-popqa-%J.err.log
#SBATCH --output=./logs/evaluate-popqa-%J.out.log
...
EVAL_FILES="/mimer/NOBACKUP/groups/${USERNAME_DIR}/APP/qa-retriever/data/atlas/popqa_data/test.jsonl"
GENERATION_NUM_BEAMS=6
NAME=evaluate-popqa-full-size-${SIZE}-ctx-${N_CONTEXT}
