...
#SBATCH --job-name=evaluate-triviaqa-64
#SBATCH --error=./logs/evaluate-triviaqa-64-%J.err.log
#SBATCH --output=./logs/evaluate-triviaqa-64-%J.out.log
...
EVAL_FILES="/mimer/NOBACKUP/groups/${USERNAME_DIR}/APP/qa-retriever/data/atlas/triviaqa_data/test.64-shot.jsonl"
GENERATION_NUM_BEAMS=6
NAME=evaluate-triviaqa-64-size-${SIZE}-ctx-${N_CONTEXT}
