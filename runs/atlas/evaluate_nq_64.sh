...
#SBATCH --job-name=evaluate-nq-64
#SBATCH --error=./logs/evaluate-nq-64-%J.err.log
#SBATCH --output=./logs/evaluate-nq-64-%J.out.log
...
EVAL_FILES="/mimer/NOBACKUP/groups/${USERNAME_DIR}/APP/qa-retriever/data/atlas/nq_data/test.64-shot.jsonl"
GENERATION_NUM_BEAMS=6
NAME=evaluate-nq-64-size-${SIZE}-ctx-${N_CONTEXT}
